      ...
      var e = function (e) {
        ...
        a = function (e) {
          var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
            a = !0 === t ? 12353 : 12449
          return e
            .replace(/[ﾜｲｴｦ]ﾞ/g, function (e) {
              return 'ヷヸヹヺ'.charAt('ﾜﾞｲﾞｴﾞｦﾞ'.indexOf(e) / 2)
            })
            .replace(/([ｦ-ｯｱｲｴｵﾅ-ﾉﾏ-ﾝ]|[ｳｶ-ﾄ]ﾞ?|[ﾊ-ﾎ][ﾞﾟ]?)/g, function (e) {
              return String.fromCharCode(n.indexOf(e) + a)
            })
            .replace(/[ﾞﾟｰ｡｢｣､･]/g, function (e) {
              return '゛゜ー。「」、・'.charAt('ﾞﾟｰ｡｢｣､･'.indexOf(e))
            })
        },
        i = function (e) {
          return a(e, !0).replace(/[ァ-ヶ]/g, function (e) {
            return String.fromCharCode(e.charCodeAt(0) - 96)
          })
        },
        o = function (e) {
          return a(e).replace(/[ぁ-ゖ]/g, function (e) {
            return String.fromCharCode(e.charCodeAt(0) + 96)
          })
        }
      function r(e) {
      ...
      kintone.events.on(
        ...
        kintone.events.on(['app.record.create.change.' + y, 'app.record.edit.change.' + y], function (n) {
          var t = (function () {
            ...
            i = a.value
          if (!i) return n
          var o = e(a.value.replace(/[ーｰ－-]/g, '')),
            r = o.slice(0, 3) + '-' + o.slice(3),
            s = new RegExp(/^[0-9]{3}-[0-9]{4}$/).test(r)
          ;(a.error = s ? null : '正しい郵便番号を入力してください'), (a.value = s ? r : i), s && t()
        })
      var w = function (e) {
